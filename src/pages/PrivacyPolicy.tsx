    ...
    <div className="max-w-4xl mx-auto space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-1000 pb-20 pt-10 px-6">
      ...
      <div className="rise-card p-10 md:p-20 space-y-16">
        <section className="space-y-6 relative group">
          ...
          <h2 className="text-2xl md:text-3xl font-display text-text-main italic font-bold">Criptografia de Dados</h2>
        ...
        <section className="space-y-6 relative group">
          ...
          <h2 className="text-2xl md:text-3xl font-display text-text-main italic font-bold">Análise de Desempenho</h2>
          <p className="text-text-sub leading-relaxed font-medium italic text-lg">
        ...
        <section className="space-y-6 relative group">
          ...
          <h2 className="text-2xl md:text-3xl font-display text-text-main italic font-bold">Isolamento de Informações</h2>
          <p className="text-text-sub leading-relaxed font-medium italic text-lg">
        ...
        <section className="space-y-6 relative group">
          ...
          <h2 className="text-2xl md:text-3xl font-display text-text-main italic font-bold">Direito ao Esquecimento</h2>
          <p className="text-text-sub leading-relaxed font-medium italic text-lg">
