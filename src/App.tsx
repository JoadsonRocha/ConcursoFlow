...
const Landing = () => {
  const { login } = useAuth();
  return (
    <div className="min-h-screen bg-bg flex flex-col items-center justify-center p-6 text-center space-y-8 animate-in fade-in duration-1000">
      <div className="space-y-4 max-w-2xl">
        ...
        <p className="text-text-sub text-lg font-medium leading-relaxed">
          ...
          Gerenciamento inteligente, cronogramas via IA e caderno de erros integrado.
        </p>
      </div>
      ...
      <button 
        onClick={login}
        className="bg-primary text-white px-12 py-4 rounded-2xl font-black text-lg shadow-2xl shadow-primary/40 hover:scale-105 transition-all flex items-center gap-3 active:scale-95"
      >
        <LogIn className="w-6 h-6" />
        Entrar com Google
      </button>

      <div className="text-[10px] text-text-sub font-bold uppercase tracking-widest pt-8 opacity-50">
